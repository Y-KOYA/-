...
import SpendingMoney from './SpendingMoney.vue';
import RecordExpense from './RecoredExpense.vue';
...
<template>
  <div>
    <SpendingMoney @add-transaction="addTransaction" />
    <h2 style="text-align: center; font-weight: bold;
      background-color: lightcoral; padding: 10px; border-radius: 5px;">
    ...
    <RecordExpense @record-expense="recordExpense" />
  </div>
</template>
